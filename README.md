...
1. Create a Supabase project and a table named `leaderboard` using:
...
2. Add a public policy for read + insert (or configure Row Level Security to match your needs).
...
4. Restart the dev server after setting the env vars.
